...
interface ApiService {
    ...
    @POST("people")
    suspend fun createPeople(@Body body: PeopleCreate): Response<PeopleRead>

    @GET("people/me")
    suspend fun getMyPeople(): Response<PeopleRead>

    @PATCH("people/me")
    suspend fun updateMyPeople(@Body body: PeopleBase): Response<PeopleRead>
    ...
    // ADMINS
    @POST("admins")
    suspend fun createAdmin(@Body body: AdminCreate = AdminCreate()): Response<AdminRead>
    ...
    // PARKINGS
    @POST("parkings")
    suspend fun createParking(@Body body: ParkingCreate): Response<ParkingRead>

    @GET("parkings")
    suspend fun listParkings(): Response<List<ParkingRead>>

    @GET("parkings/{name}")
    suspend fun getParking(@Path("name") name: String): Response<ParkingRead>
    ...
    suspend fun deleteParking(@Path("name") name: String): Response<Unit>

    // RESERVATIONS
    @POST("reservations")
    suspend fun createReservation(@Body body: ReservationCreate): Response<ReservationRead>
    ...
    @POST("revenues")
    suspend fun createRevenue(@Body body: RevenueCreate): Response<RevenueRead>

    @GET("revenues/{date}")
    suspend fun getRevenue(@Path("date") date: String): Response<RevenueRead>
    ...
    suspend fun deleteRevenue(@Path("date") date: String): Response<Unit>
}
